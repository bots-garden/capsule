...
var CouchBaseQuery = api.GoModuleFunc(func(ctx context.Context, module api.Module, params []uint64) []uint64 {
    ...
    queryPosition := uint32(params[0])
    queryLength := uint32(params[1])
