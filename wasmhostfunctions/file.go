...
func hostReadFile(ptrPos uint32, size uint32, retBuffPtrPos **byte, retBuffSize *int)
...
*/
func ReadFile(message string) (string, error) {

	filePathPtrPos, size := GetStringPtrPositionAndSize(message)
